...
searchForm.addEventListener('submit', function onSearchFormSumited(event) {
...
viewMode.addEventListener('click', function onViewModeChanged(event) {
  if (event.target.matches('.poster-view')) {
    mode = 'poster'
    renderMovieList(getMoviesByPage(nowPage))
